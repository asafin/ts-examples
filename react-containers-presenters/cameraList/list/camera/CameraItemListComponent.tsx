...
class CameraItemListComponent extends ComponentBase<Props, State>  {

    constructor (props: Props){
        super (CameraItemListComponent.name, props)
    ...
    public readonly render = () => {
        const componentClass = CameraItemListComponent.name
        ...
        return (
            <div className={componentClass}>
                <div className={`${componentClass}__column ${componentClass}__column_left`}>
                    ...
                    <div className={`${componentClass}__secondary`}>
...
export default withClientApplicationContext(CameraItemListComponent)